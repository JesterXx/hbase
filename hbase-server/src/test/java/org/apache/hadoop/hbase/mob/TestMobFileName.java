...
public class TestMobFileName extends TestCase {
  ...
  public void testHashCode() {
    assertEquals(
      MobFileName.create(Integer.toString(startKey),
  ...
  public void testGet() {
    MobFileName mobFileName = MobFileName.create(
        Integer.toString(startKey), dateStr, uuid);
    assertEquals(Integer.toString(startKey),
      mobFileName.getStartKey()); // getStartKey
    assertEquals(dateStr, mobFileName.getDate()); // getDate
    assertEquals(
      mobFileName.getFileName(),
      Integer.toString(startKey) + dateStr + uuid); // getFileName
  }
